...
public class PreviewImgFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.sl_fragment_preview_img, null);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.sl_menu_edit, menu);
    ...
    private void setBWcolors() {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    transformed = ((ScannerActivity) getActivity()).getBWBitmap(original);
    ...
    private void setGrayScaleColors() {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    transformed = ((ScannerActivity) getActivity()).getGrayBitmap(original);
                } catch (final OutOfMemoryError e) {
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void setAutoFixColors() {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    transformed = ((ScannerActivity) getActivity()).getMagicColorBitmap(original);
                } catch (final OutOfMemoryError e) {
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
