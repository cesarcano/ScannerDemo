...
public class PolygonView extends FrameLayout {
    ...
    private void initPaint() {
        paint = new Paint();
        paint.setColor(Color.parseColor(LibEnvironment.getInstance().getColorTheme().getColorPrimary()));
    ...
    private ImageView getImageView(int x, int y) {
        ...
        imageView.setImageResource(R.drawable.sl_circle);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            imageView.setImageTintList(ColorStateList.valueOf(Color.parseColor(LibEnvironment.getInstance().getColorTheme().getColorPrimary())));
        imageView.setX(x);
        imageView.setY(y);
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints())) {
                        color = Color.parseColor(LibEnvironment.getInstance().getColorTheme().getColorPrimary());
                    } else {
                        color = Color.parseColor(LibEnvironment.getInstance().getColorTheme().getColorPrimary());
                    }
