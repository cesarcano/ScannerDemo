...
import com.scanlibrary.LibEnvironment;
...
public class PolygonView extends FrameLayout {
    ...
    private ImageView getImageView(int x, int y) {
        ...
        Drawable drawable = context.getResources().getDrawable(R.drawable.sl_circle);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawable.setTintList(ColorStateList.valueOf(Color.parseColor(LibEnvironment.getInstance().getColorTheme().getColorPrimary())));
        }
